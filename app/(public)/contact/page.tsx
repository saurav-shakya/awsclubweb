              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      href="https://www.instagram.com/awscloudcommunity_gcet/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center w-12 h-12 bg-gray-800 rounded-lg hover:bg-aws-orange hover:text-aws-navy transition-colors"
                ...
                <div>
                  ...
                  <div className="w-full h-64 rounded-lg overflow-hidden border border-gray-700">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.7380647542413!2d77.49505052620617!3d28.45731139201498!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cc1dc8b29c0e1%3A0x4ee84fe65c694f0!2sGALGOTIAS%20COLLEGE%20OF%20ENGINEERING%20AND%20TECHNOLOGY%2C%20Knowledge%20Park%20II%2C%20Greater%20Noida%2C%20Uttar%20Pradesh%20201310!5e0!3m2!1sen!2sin!4v1775407319048!5m2!1sen!2sin"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                      ...
                      title="Galgotias College of Engineering and Technology Location"
                    />
                  </div>
                </div>
              </div>
